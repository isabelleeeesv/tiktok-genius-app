...
const GeneratorTool = ({ auth, user, db, userData, navigate, guestGenerations, setGuestGenerations, setShowLoginModal }) => {
    ...
    const ideaTypes = [
        ...
        { name: 'Trending Audio', icon: <Music />, prompt: `3 trending TikTok audios (including remixes or lesser-known versions) that are available in the TikTok Commercial Music Library (CML) and can be used for TikTok Shop/affiliate videos. For each, provide:\n- Song title\n- Artist\n- A short reason why it fits this product.\nYou may suggest remixes, covers, or alternate versions if they are marked as 'Commercially Licensed' and available for TikTok Shop videos. Do NOT suggest mainstream, big, or popular songs or artists (e.g. no Taylor Swift, Drake, Olivia Rodrigo, etc). Only suggest lesser-known, commercial-use audios.\nIMPORTANT: Double check that the song name and artist actually exist and are a real match. If you are not 100% sure the audio exists in the TikTok Commercial Music Library, reply 'No suitable audio found.'`, premium: true },
